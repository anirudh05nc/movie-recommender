...
# 👥 Team Details
st.markdown("<h4 style='text-align: center;'>TEAM DETAILS</h4>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;'>K BHAVYA SREE</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;'>T BHAVANA</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;'>NANDINI</p>", unsafe_allow_html=True)
